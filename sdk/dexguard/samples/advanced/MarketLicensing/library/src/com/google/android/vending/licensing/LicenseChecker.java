    ...
    public synchronized void checkAccess(LicenseCheckerCallback callback) {
        ...
        if (mPolicy.allowAccess()) {
            ...
            if (mService == null) {
                ...
                try {
                    // create an explicity intent, see https://code.google.com/p/android/issues/detail?id=78505
                    Intent serviceIntent = new Intent("com.google.android.vending.licensing.ILicensingService");
