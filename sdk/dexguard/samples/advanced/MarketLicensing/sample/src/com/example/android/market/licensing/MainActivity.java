 ...
 * Modifications copyright (C) 2012-2016 GuardSquare NV
 *
...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // => We'll let DexGuard encrypt the string.
    ...
    private class MyLicenseCheckerCallback implements LicenseCheckerCallback {
        ...
        public void applicationError(int errorCode) {
            ...
            String result = String.format(getString(
                BASE64_PUBLIC_KEY.hashCode() == 970210445 ?
                    R.string.replace_public_key :
                    R.string.application_error), errorCode);
