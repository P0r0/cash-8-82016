...
public class About extends Base {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.activity_about, frameLayout, true);
        typeFace(frameLayout);
        try {
            this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        }catch(Exception e){}
       // getLayoutInflater().inflate(R.layout.activity_about, frameLayout, true);
        //typeFace(frameLayout);
        ...
        vue.loadUrl("file:///android_asset/docs/about.html");
    }
